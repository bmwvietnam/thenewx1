...
<html lang="en">
    <head>
        ...
        <title>BMW X1: Payment cancelled | bmw.com.sg</title>
        <meta name="description" content="No payment was processed and your transaction has not been completed.">
    ...
    <body>
        ...
        <section id="thankyou">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="mb-4">YOUR PAYMENT HAS BEEN CANCELLED.</h2>
                        <p class="mb-4">No payment was processed and your transaction has not been completed.</p>

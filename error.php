...
<html lang="en">
    <head>
        ...
        <title>BMW X1: Payment error | bmw.com.sg</title>
        <meta name="description" content="There was an error in the payment process. Please make sure all payment details are correct and try again.">
        <meta property="og:url" content="https://bethefirst.bmw.com.sg/the7/" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="BMW X1" />
        <meta property="og:description" content="Be among the first to reserve and enjoy exhilarating benefits on the new BMW X1." />
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-6RD5R10510"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'G-6RD5R10510');
        </script>
        ...
        <div class="container-fluid container-sm">
            <div class="row">
                <div class="col-12 position-relative">
                   <img id="bmw-logo" src="images/bmw-logo-grey.png" width="55" height="55">
                </div>
            </div>
        </div>
        <section id="thankyou">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="mb-4">YOUR PAYMENT HAS NOT BEEN PROCESSED.</h2>
                        <p class="mb-4">There was an error in the payment process. Please make sure all payment details are correct and try again.</p>
                        <a class="btn btn-primary" href="https://bethefirst.bmw.com.sg/theX1/">Back to home</a>
                    </div>
                </div>
            </div>
        </section>

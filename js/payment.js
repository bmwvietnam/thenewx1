                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if(responseData.status == 'success'){
                                        window.parent.location.href = 'https://bethefirst.bmw.com.sg/theix3/thankyou.php?ref=' + responseData.refCode;
                                    } else if(responseData.status == 'cancelled'){
                                        window.parent.location.href = 'https://bethefirst.bmw.com.sg/theix3/cancelled.php';
                                    } else if(responseData.status == 'refused'){
                                        window.parent.location.href = 'https://bethefirst.bmw.com.sg/theix3/refused.php';
                                    } else if(responseData.status == 'error'){
                                        window.parent.location.href = 'https://bethefirst.bmw.com.sg/theix3/error.php'
                                    }
                                }
                            })

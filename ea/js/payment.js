                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if(responseData.status == 'success'){
                                        window.parent.location.href = 'https://bethefirst.bmw.com.sg/the7/pml/thankyou.php?ref=' + responseData.refCode;
                                    } else if(responseData.status == 'cancelled'){
                                        window.parent.location.href = 'https://bethefirst.bmw.com.sg/the7/pml/cancelled.php';
                                    } else if(responseData.status == 'refused'){
                                        window.parent.location.href = 'https://bethefirst.bmw.com.sg/the7/pml/refused.php';
                                    } else if(responseData.status == 'error'){
                                        window.parent.location.href = 'https://bethefirst.bmw.com.sg/the7/pml/error.php'
                                    }
                                }
                            })
